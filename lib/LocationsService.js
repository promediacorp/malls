...
function LocationsService() {
	...
	parseCSV = function(text) {
		...
		var name,description,rank,city,state,leasable_area,opened,renovated,levels,food_court;
		...
		for (var i = 1; i < lines.length; i++) {
			...
			pms = new esri.symbol.PictureMarkerSymbol("images/purple.png",22,22);			
			attr = {name:name,description:description,rank:rank,city:city,state:state,leasable_area:leasable_area,opened:opened,renovated:renovated,levels:levels,food_court:food_court};
	...
	function compare(a,b) {
		rank_a = parseInt(a.attributes.rank);
		rank_b = parseInt(b.attributes.rank);
