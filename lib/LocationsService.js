...
function LocationsService() {
	...
	parseCSV = function(text) {
		...
		var name,description,rank,city,state,leasable_area,opened,renovated;
		...
		for (var i = 1; i < lines.length; i++) {
			...
			attr = {name:name,description:description,rank:rank,city:city,state:state,leasable_area:leasable_area,opened:opened,renovated:renovated};
