...
function LocationsService() {
	...
	parseCSV = function(text) {
		...
		var name,description,rank,city,state,leasable_area,opened,renovated,levels,food_court,website;
		...
		for (var i = 1; i < lines.length; i++) {
			...
			pms = new esri.symbol.PictureMarkerSymbol("images/PurplePin.png",21,24);	
			pms.setOffset(0,7);		
			attr = {
				name:name,
